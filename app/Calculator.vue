...
export default {
  ...
  beforeMount: function() {
    ...
    console.log(this.$root.options.onInit);
  },
  mounted: function() {
    if (
      this.$root.options.onInit &&
      window[this.$root.options.onInit] &&
      typeof window[this.$root.options.onInit] == "function"
    )
  ...
  <form class="calculation" @submit.prevent="action">
    ...
    <div class="calculation__group form-group">
        ...
        <div class="calculation__col col-4">
          <div class="calculation__input-group input-group">
            <input
              ...
              type="text"
              v-model="w.height"
              class="form-control calculation__input"
              placeholder="Высота"
              name="window_height"
            />
      ...
      <div class="calculation__add-btn-wrapper text-right">
        <button
          type="button"
          class="calculation__btn btn btn-success btn-sm"
          @click="windows.push({})"
    ...
    <div class="calculation__group form-group">
      ...
      <div>
        <div
          v-for="(v, k) in { prof_brus: 'профилированный брус', brevno: 'оцилиндрованное бревно', kley_brus: 'клееный брус', ruchnoe_brevno: 'бревно ручной рубки' }"
          class="calculation__radio form-check form-check-inline"
        >
          <input
            :id="'check_' + k"
            name="wall_material"
            v-model="wall_material"
    ...
    <div class="calculation__group form-group">
      ...
      <div>
        <div
          v-for="(v, k) in { stoimost_obsad: 'стоимости обсад', podgotovka_proemov: 'подготовка проёмов', montazh_obsad: 'сборка и монтаж обсад', dostavka: 'доставка' }"
          class="calculation__checkbox form-check form-check-inline"
        >
          <input
            :id="'check_' + k"
            name="calculation_items"
            v-model="calculation_items"
            class="form-check-input"
            type="checkbox"
            :value="k"
          />
    ...
    <div class="calculation__group form-group">
      ...
      <div>
        <div
          v-for="(v, k) in { '40mm': '40 мм', '65mm': '65 мм', any: 'неважно' }"
          class="calculation__radio form-check form-check-inline"
        >
          <input
            :id="'check_' + k"
            name="casing_thickness"
            v-model="casing_thickness"
            class="form-check-input"
            type="radio"
            :value="k"
          />
    ...
    <div class="calculation__group form-group">
      ...
      <input
        v-model="email"
        type="email"
        class="calculation__input form-control"
    ...
    <div class="form-group">
      ...
      <textarea class="form-control calculation__input" v-model="info" name="info"></textarea>
    </div>
